...
@WebSocketGateway({ serveClientSid: true }) // Enable client ID access
export class ChatGateway {
  constructor(private readonly chatService: ChatService, private readonly userService: UsersService, ) {}
  ...
  handleMessage(@MessageBody() data: { sender: string; recipient: string; message: string }) {
